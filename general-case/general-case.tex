...
The optimization problems \eqref{equation:optimization-problem} cannot be solved
exactly by an online algorithm. We thus need to define appropriate notions of
approximate solution for the problem. For any $\epsilon \ge 0$, we define the
notion of $\epsilon$-feasible and $\epsilon$-optimal solutions.
...
number. Then, there exists a sequence of actions $a_1', a_2', \dots, a_T'$ such that
\begin{align*}
...
We construct a sequence of actions $a_1'', a_2'', \dots, a_T''$. We define
$a_t''$ be the element of $\Psi(R_t,\epsilon)$ that is closest to $a_t'$ in the
