...
advertisment auction. The coordinates of the action $x_t$ are the business
...
boundedness assumption allows us to standard probabilistic concentration
...
patterns at multiple time scales (daily, weekly, etc.). Nevertheless, the
i.i.d. assumption is a good approximation if the $T$ requests span long
enough time period.
