...
\le (M+1)\sqrt{8 \frac{\ln(T) + 2\ln(N)}{T} } + \sqrt{ \frac{\log(1/\delta)}{2T} } \: .
$$
\end{theorem}
...
$\sigma$-sub-Gaussian random with $\sigma=T$. That is, $Y_v$ satisfies
$$
...
hyperplanes in $\R^{M+1}$ on $\binom{N}{2} T$ points. Vapnik-Chervonenkis dimension
of hyperplanes of homogeneous hyperplanes in $\R^{M+1}$. Thus, the
number of behaviors of homogeneous hyperplanes in $\R^{M+1}$ on $\binom{N}{2} T$ points
...
$$
Therefore, the cardinality of $V$ is upper bounded by
$$
